...
# content
st.write('Check out examples of how to use the PyThermoDB package in the [documentation](https://pythermodb.readthedocs.io/en/latest/).')

st.write('You can also have a look at `tests folder` in the github repository to see how the package is used.')

# ask question
st.write('If you have any questions or would like to report a bug, please open an issue in the [github repository](https://github.com/sinagilassi/PyThermoDB/issues)')