...
# ====================================
# display a table
tb_info = thermo_db.table_info('CUSTOM-REF-1', 'Ideal-Gas-Heat-Capacity')
print(tb_info)
...
# table-equation for Ideal-Gas-Heat-Capacity
tb_eq = thermo_db.equation_load('CUSTOM-REF-1', 'Ideal-Gas-Heat-Capacity')
# equation structure
tb_eq_structure = tb_eq.eq_structure()
print(tb_eq_structure)
print(tb_eq.eqs_structure())
