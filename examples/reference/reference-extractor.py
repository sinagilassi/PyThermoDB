...
This file is used in PyThermoDB
      ...
      TABLES:
        ...
        Vapor-Pressure:
          ...
          EQUATIONS:
            EQ-1:
              BODY:
                - parms['Constant1 | C1 | 1'] = parms['Constant1 | C1 | 1']/1
                - parms['Constant2 | C2 | 1'] = parms['Constant2 | C2 | 1']/1
                - parms['Constant3 | C3 | 1'] = parms['Constant3 | C3 | 1']/1
                - parms['Constant4 | C4 | 1'] = parms['Constant4 | C4 | 1']/1
                - parms['Constant5 | C5 | 1'] = parms['Constant5 | C5 | 1']/1
                - res['vapor-pressure | VaPr | Pa'] = math.exp(parms['Constant1 | C1 | 1'] + parms['Constant2 | C2 | 1']/args['temperature | T | K'] + parms['Constant3 | C3 | 1']*math.log(args['temperature | T | K']) + parms['Constant4 | C4 | 1']*(args['temperature | T | K']**parms['Constant5 | C5 | 1']))
              BODY-INTEGRAL:
                None
              BODY-FIRST-DERIVATIVE:
                None
              BODY-SECOND-DERIVATIVE:
                None
          STRUCTURE:
            COLUMNS: [No.,Name,Formula,State,Constant1,Constant2,Constant3,Constant4,Constant5,Tmin,P(Tmin),Tmax,P(Tmax),Eq]
...
# Display extracted YAML content
if result['sections']:
