...
from pyThermoDB.references import load_custom_reference
...
# ===============================
custom_reference_loaded = load_custom_reference(
    custom_reference=ref1,
    save_to_file=True,
    file_format='txt',
    file_name='custom_ref1',
...
# ===============================
# init
ref = ptdb.ref(custom_reference=ref1)
