...
# NOTE: custom ref
custom_reference: Dict[str, Any] = {'reference': [file_contents]}
# md ref
# custom_reference = {'reference': [md_path]}
# yml ref
...
# ====================================
# NOTE: set table
table_ = 'NRTL Non-randomness parameters-1'
...
methanol|ethanol:
    nrtl:
        ...
        table: NRTL Non-randomness parameters-1
        symbols:
            alpha: alpha
            a_i_j: a_i_j
            b_i_j: b_i_j
