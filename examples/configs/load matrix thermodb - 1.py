...
# ref
thermodb_file = 'mixture methanol-ethanol.pkl'
...
# SECTION: load data
nrtl_alpha_data = nrtl_thermodb.check_property(
...
# NOTE: new format
# ! retrieve
nrtl_data_ = f"CUSTOM-REF-1::NRTL Non-randomness parameters-2 | a_i_j | {comp1} | {comp2}"
print(
...
# ! retrieve
nrtl_data_ = f"CUSTOM-REF-1::NRTL Non-randomness parameters-2 | a_{comp1}_{comp2}"
print(
    nrtl_thermodb.retrieve(
        nrtl_data_,
        message=f"NRTL Alpha value {comp1}-{comp2}"
...
nrtl_data_ = f"CUSTOM-REF-1::NRTL Non-randomness parameters-2 | b_{comp1}_{comp2}"
print(
    nrtl_thermodb.retrieve(
        nrtl_data_,
        message=f"NRTL Alpha value {comp1}-{comp2}"
