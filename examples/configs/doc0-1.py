...
# SECTION: parse table equation with respect to table structure
table_structure_ = ReferenceChecker_.get_table_structure(
    'CUSTOM-REF-1',
    'ideal-gas-heat-capacity'
)

parsed_equation_with_structure_ = parse_equation_body_with_table_structure(
    equation_body=table_equations_,
