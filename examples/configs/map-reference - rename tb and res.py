...
# TODO: Example to demonstrate renaming table and property symbols during mapping
# ! different table name and result property name in the equation body
          ...
          EQUATIONS:
            EQ-1:
              BODY:
                ...
                - res['vapor_pressure | VaPr | Pa'] = math.exp(parms['C1 | C1 | 1'] + parms['C2 | C2 | 1']/args['temperature | T | K'] + parms['C3 | C3 | 1']*math.log(args['temperature | T | K']) + parms['C4 | C4 | 1']*(args['temperature | T | K']**parms['C5 | C5 | 1']))
              BODY-INTEGRAL:
                None
              BODY-FIRST-DERIVATIVE:
                None
...
ignore_state_props = ['VaPr', 'MW', 'Cp_IG']
