      ...
      TABLES:
        ideal-gas-heat-capacity-constant-pressure:
          ...
          EQUATIONS:
            EQ-1:
              BODY:
                - res['ideal-gas-heat-capacity-constant-pressure | Cp_IG | J/mol.K'] = (parms['a0 | a0 | 1'] + parms['a1 | a1 | 1E3']*args['temperature | T | K'] + parms['a2 | a2 | 1E5']*(args['temperature | T | K']**2) + parms['a3 | a3 | 1E8']*(args['temperature | T | K']**3) + parms['a4 | a4 | 1E11']*(args['temperature | T | K']**4))*parms['Universal-Gas-Constant | R | J/mol.K']
              BODY-INTEGRAL:
        ...
        NRTL Non-randomness parameters-2:
          ...
          VALUES:
            ...
            - [1,methane|ethanol,methanol,CH3OH,l,0,0.300492719,0,1.564200272,0,35.05450323,0,4.481683583]
