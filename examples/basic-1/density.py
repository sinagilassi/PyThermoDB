...
# ===============================
# select a table
tb_select = tdb.select_table("Perry's Chemical Engineers' Handbook",
                             'TABLE 2-32 Densities of Inorganic and Organic Liquids')
print(tb_select)

# display a table
tb_info = tdb.table_info("Perry's Chemical Engineers' Handbook",
                         'TABLE 2-32 Densities of Inorganic and Organic Liquids')
print(tb_info)
...
# ===============================
# table load
res_ = tdb.table_data("Perry's Chemical Engineers' Handbook",
                      'TABLE 2-32 Densities of Inorganic and Organic Liquids')
print(res_)
print(type(res_))
...
# tdb.table_view("Perry's Chemical Engineers' Handbook",
#                'TABLE 2-32 Densities of Inorganic and Organic Liquids')
...
rho_tb = tdb.equation_load("Perry's Chemical Engineers' Handbook",
                           'TABLE 2-32 Densities of Inorganic and Organic Liquids')
print(rho_tb.eq_structure(1))
print(rho_tb.eq_structure(2))
# ====================================
